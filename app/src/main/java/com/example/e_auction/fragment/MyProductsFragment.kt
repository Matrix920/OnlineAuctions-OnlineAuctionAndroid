...
import com.example.e_auction.activity.MainActivity
import com.example.e_auction.application.MyApplication
import com.example.e_auction.list_view.MyProductsAdapter
 ...
 * [MyProductsFragment.OnFragmentInteractionListener] interface
...
class MyProductsFragment : Fragment() {
    ...
    public lateinit var mAdapter:MyProductsAdapter
    private  lateinit var recyclerView: RecyclerView
    lateinit var listProducts:ArrayList<Product>

    val TAG=MyProductsFragment::class.java.simpleName
...
//        setupSearchView()
    ...
    fun fetch() {
        val link=APIs.myProducts(MyApplication.getInstance().getSession().UserID)
    ...
    fun setupRecyclerView() {
        ...
        mAdapter= MyProductsAdapter(listProducts,v.context)
